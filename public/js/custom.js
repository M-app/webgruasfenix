...
var companyName = "Grúas Fénix"; // Enter your event title
...
$('.vehicle-nav-scroll').click(function(){
    var direction = $(this).data('Guatemala');
...
$("#location-map-select").append('<option value="'+locations[0].value+'">Seleccione una localidad</option>');
